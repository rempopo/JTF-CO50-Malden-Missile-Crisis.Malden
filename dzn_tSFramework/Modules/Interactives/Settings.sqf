	...
	*/
	...
	[
		...
		, {
			[
				_this
				, "Deploy on <t color='#FF0000'>Red Beach</t>"
				, { [(getPos RedBeach), player] spawn tSF_fnc_adminTools_teleportTo }
				, 5
	...
	, [
		...
		, {
			[
				_this
				, "Deploy on <t color='#00FF00'>Green Beach</t>"
				, { [(getPos GreenBeach), player] spawn tSF_fnc_adminTools_teleportTo }
				, 5
			] call dzn_fnc_addAction
		}
		, "client"
